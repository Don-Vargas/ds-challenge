...
from config.paths import IMPORTANCE_FIGS_DIR


def create_importance_figs():
    # Load registry
    ...
    # Save final plot
    output_plot_path = os.path.join(IMPORTANCE_FIGS_DIR, 'all_plots_grid_from_registry.png')
